# Generated by Django 5.1.1 on 2025-01-17 05:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ROLE_CUSTOMER', 'Customer'), ('ROLE_SELLER_OWNER', 'Seller'), ('ROLE_ADMIN', 'Admin')], max_length=21)),
            ],
        ),
        migrations.CreateModel(
            name='Payment',
        ...
        migrations.AddField(
            model_name='order',
            name='user',
            field=models.ForeignKey(limit_choices_to={'role': 'ROLE_CUSTOMER'}, on_delete=django.db.models.deletion.CASCADE, related_name='orders', to='ecom.user'),
        ),
        migrations.CreateModel(
            name='Checkout',
            fields=[
