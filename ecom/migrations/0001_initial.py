# Generated by Django 5.1.5 on 2025-02-14 09:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Pending'), ('ready_to_ship', 'Ready_To_Ship'), ('shipped', 'Shipped'), ('completed', 'Completed'), ('cancelled', 'Cancelled')], default='pending', max_length=15)),
                ('order_date', models.DateField(auto_now_add=True)),
                ('dispatch_date', models.DateField(blank=True, help_text='The date the item was dispatched.', null=True)),
                ('delivery_date', models.DateField(blank=True, help_text='The estimated delivery date.', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='billing_addresses', to='ecom.user', unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='BankDetails',
