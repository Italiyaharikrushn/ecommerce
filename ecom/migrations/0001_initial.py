# Generated by Django 5.1.5 on 2025-01-31 09:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ROLE_CUSTOMER', 'Customer'), ('ROLE_SELLER_OWNER', 'Seller Owner'), ('ROLE_ADMIN', 'Admin')], max_length=21)),
            ],
        ),
        migrations.CreateModel(
            name='Payment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Pending'), ('ready_to_ship', 'Ready_To_Ship'), ('completed', 'Completed'), ('cancelled', 'Cancelled')], default='pending', max_length=15)),
                ('dispatch_date', models.DateField(blank=True, help_text='The date the item was dispatched.', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('seller', models.ForeignKey(blank=True, limit_choices_to={'role': 'ROLE_SELLER_OWNER'}, null=True, on_delete=django.db.models.deletion.CASCADE, to='ecom.user')),
            ],
        ),
        migrations.AddField(
            model_name='product',
            name='seller',
            field=models.ForeignKey(limit_choices_to={'role': 'ROLE_SELLER_OWNER'}, on_delete=django.db.models.deletion.CASCADE, to='ecom.user'),
        ),
        migrations.AddField(
            model_name='order',
            name='user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='billing_address', to='ecom.order')),
